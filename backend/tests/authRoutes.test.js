...
test('POST /api/admin/signup is not available', async () => {
  const response = await request(app).post('/api/admin/signup').send({}).expect(404);
...
test('GET /api/admin/maintenance/archived-employees requires admin authentication', async () => {
